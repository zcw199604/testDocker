...
import com.example.uiservice.model.HealthResponse;
...
/**
 * Exposes a custom health endpoint for ui-service monitoring.
 */
@RestController
...
public class HealthController {
    ...
    public HealthController(
            ...
            @Value("${spring.application.name:ui-service}") String applicationName) {
